...
Problem:
  -return array of node values (property 'val')
  -null points on tree are just 'null', not a node with val=null

Alg:
  -LNR, recursively
  -use helper func with results array in its closure
  -make sure to call it with provided root
  -immediate return nothing if base case of null (missing node)
